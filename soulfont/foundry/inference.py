...
# Runnable straight from the command line as well as importable. Executing the file puts
# this package's own directory on sys.path, not the project root, so the root-level
# models/, datasets/ and utils/ packages would otherwise be invisible.
