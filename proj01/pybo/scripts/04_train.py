...
import os
import sys
from tensorflow.python.training import saver as saver_lib # type: ignore
...
#     for f in files:
#         if f.startswith("unet.model") and f.endswith(".index"):
#             return True
#     return False

# ckpt_path = os.path.join(args.experiment_dir, "checkpoint", f"experiment_{args.experiment_id}_batch_{args.batch_size}")
